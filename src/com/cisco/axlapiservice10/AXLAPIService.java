    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            logger.warning("Failed to create URL for the wsdl Location: './wsdl/10/AXLAPI.wsdl', retrying as a local file");
    ...
    public com.cisco.axlapiservice10.AXLPort getAXLPort() {
        return super.getPort(new QName("http://www.cisco.com/AXLAPIService/", "AXLPort"), com.cisco.axlapiservice10.AXLPort.class);
    }
     ...
     */
    @WebEndpoint(name = "AXLPort")
    public com.cisco.axlapiservice10.AXLPort getAXLPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.cisco.com/AXLAPIService/", "AXLPort"), com.cisco.axlapiservice10.AXLPort.class, features);
    }
